 ...
 */
final class Version20200501075939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE typeOperation ADD libelle_rapport VARCHAR(100) DEFAULT NULL, CHANGE checkable checkable TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE typeOperation DROP libelle_rapport, CHANGE checkable checkable TINYINT(1) DEFAULT \'0\' NOT NULL');
